...
export default function ShadowWarrior2Article() {
  return (
    <ArticleLayout
      title="Shadow Warrior 2 Preview: Not Silent, Very Deadly"
      subtitle="Wailing guitar, lovably cheesy one-liners, and more guts than an abattoir during barbecue season."
